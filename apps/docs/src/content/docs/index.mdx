...
<CardGrid stagger>
  ...
  <Card title="Snake" icon="rocket">
    Canvas Snake with a `requestAnimationFrame` loop via `<cinq-snake>`.

    [Read the Snake docs](components/snake/)
  </Card>
</CardGrid>
...
<CardGrid stagger>
  <Card title="Utils" icon="document">
    ...
    [Read the Utils reference](reference/utils/)
  </Card>
</CardGrid>
