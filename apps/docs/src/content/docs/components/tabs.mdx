...
The live demo below wires `tab-before-activate` to a public monster reference API and only activates the tab once the creature data has been fetched and rendered:
