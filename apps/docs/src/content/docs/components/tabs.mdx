...
### Automatic activation (`data-delay`)
...
<div class="not-content">
  <cinq-tabs class="block flex flex-col gap-4" data-hash="false" data-delay="0">
    <div
      role="tablist"
  ...
  <div class="flex flex-col gap-8">
    <cinq-tabs class="block flex flex-col gap-4" data-hash="false" data-delay="0">
      ...
      >
        ...
        <cinq-tabs class="block flex flex-col gap-3" data-hash="false" data-delay="0">
          <div
            role="tablist"
